/*
 extraction_init.sqf v1.22 by Jigsor
...
JIG_EX_Chopper_Type	= 	["B_CTRG_Heli_Transport_01_tropic_F","B_Heli_Transport_01_F"];// Desired Evac Chopper classname in quotes and array.
...
JIG_EX_Random_Type	=	false;							// Select random Heli Type from JIG_EX_Chopper_Type. If False, Fist Vehicle in array JIG_EX_Chopper_Type is chosen. Example: JIG_EX_Chopper_Type = ["B_Heli_Transport_01_camo_F","CH49_Mohawk_FG"];
